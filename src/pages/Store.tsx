...
export default function Store() {
  ...
  const storeColumns: DataTableColumn<AutoReceivedItem>[] = [
    ...
    },
    {
      ...
      render: (r) => (
        <div className="flex items-center gap-1.5 text-[#2F5472] dark:text-blue-300 font-mono text-[11px] font-bold">
    ...
    },
    {
      ...
      render: (r) => (
        <span className="text-slate-450 dark:text-slate-505 font-mono text-[11px]">
    ...
    },
    {
      ...
      filterType: 'select',
      render: (r) => (
        <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[11px] font-black uppercase tracking-wider bg-emerald-100 text-emerald-800 font-mono">
        ...
        <DataTable
          ...
          toolbarExtra={
            <div className="flex flex-wrap items-center gap-1.5">
              <span className="text-[11px] text-slate-400 uppercase font-mono font-bold hidden sm:inline">
                Node:
              </span>
              {branches.map((br) => (
                <button
                  ...
                  className={cn(
                    'px-2.5 py-1 rounded-md text-[11px] font-extrabold uppercase tracking-tight transition-all cursor-pointer whitespace-nowrap border',
                    selectedBranch === br
